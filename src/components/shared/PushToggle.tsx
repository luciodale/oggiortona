...
export function PushToggle() {
  ...
  return (
    <button
      ...
      aria-pressed={isOn}
      aria-busy={busy}
      className={`shrink-0 flex items-center gap-1.5 rounded-lg bg-card px-3 py-1.5 text-[12px] font-semibold shadow-card transition-colors active:scale-[0.97] disabled:opacity-60 disabled:cursor-not-allowed ${
        state === "denied"
