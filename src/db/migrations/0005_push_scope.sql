-- Add scope column to push_subscriptions.
-- SQLite requires table rebuild for composite unique constraint changes.
...
INSERT INTO push_subscriptions_new (id, user_id, endpoint, p256dh, auth, scope, created_at)
  SELECT id, user_id, endpoint, p256dh, auth, 'admin', created_at FROM push_subscriptions;
