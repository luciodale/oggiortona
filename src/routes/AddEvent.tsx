...
export function AddEventRoute() {
  ...
  return (
    <div className="py-4">
      <Link to="/profile" className="mb-4 inline-flex items-center gap-1 text-xs font-medium text-muted no-underline hover:text-primary">
        <ArrowLeftIcon className="h-3.5 w-3.5" />{t("profile.backToProfile")}
      </Link>
